...
- Link format: `https://townsquare.lightning.force.com/lightning/r/Lead/${lead.id}/view`
...
**Replace with:**
```javascript
<td><a href="https://townsquare.lightning.force.com/lightning/r/Lead/${e.salesforce_lead_id}/view" target="_blank" style="font-family: monospace; font-size: 11px;">${e.salesforce_lead_id}</a></td>
```
...
This matches the exact pattern used in unenriched leads table (line 1977). Do NOT change anything else in the table - only this one cell.
  ...
  <verify>
Grep for the updated link: `grep -n "townsquare.lightning.force.com.*salesforce_lead_id" public/index.html`
...
<task type="checkpoint:human-verify" gate="blocking">
  ...
  <how-to-verify>
    ...
    3. Test KPIs Lead ID Links:
       ...
       - Verify link format matches: `https://townsquare.lightning.force.com/lightning/r/Lead/{ID}/view`
